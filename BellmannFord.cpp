...
int main()
{
    ...
    E[0].x = 0, E[0].y = 1, E[0].weight = 3;
    E[1].x = 1, E[1].y = 2, E[1].weight = 6;

    E[2].x = 2, E[2].y = 3, E[2].weight = -2;
    E[3].x = 3, E[3].y = 2, E[3].weight = -7;

    E[4].x = 4, E[4].y = 3, E[4].weight = 6;
    E[5].x = 3, E[5].y = 0, E[5].weight = 3;

    E[6].x = 0, E[6].y = 4, E[6].weight = 5;
    E[7].x = 1, E[7].y = 4, E[7].weight = 2;
    E[8].x = 4, E[7].y = 1, E[7].weight = 1;
